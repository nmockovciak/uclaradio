...
db.getAllBlurbs = function(callback) {
	DjBlurbModel.find({}, function(err, blurbs) {
		...
		arrayBlurbs = [{
			djName: "dj Nutmeg", 
			showName: "Get a Shornter show name: Going easy on Web", 
			genre: "eclectic", 
		...
		{
			djName: "dj Nutmeg", 
			showName: "Austinite ranting about rude Angelenos", 
			genre: "eclectic", 
			about: "Oh she's weird blah blah bleh na i got my coconut water and am like i like your backstroke dawg",
			site: "www.reganhsu.com",
			timeslot: "12pm",
			day: "Friday",
			image: ""
